...
int main()
{
    ...
    while (getline(file, line))
    {
        ...
        else
        {
            ...
            {
                string bin = line.substr(i, 2);
                unsigned char first = bin[0];
                unsigned char second = bin[1];
    ...
    while (choice == "1" || choice == "2" || choice == "3")
    {
        if (choice == "1")
        {
            ...
            else
            {
                ...
                cout << "\nThe hash map took " << (float)timetest / CLOCKS_PER_SEC << " seconds to find the sum." << endl;
                cout << "\n\n --- Graph Result ---- \n\n";
        ...
        else if (choice == "3")
        {
            ...
            else if (input.size() > 2)
            {
                ...
                cout << "\n --- Unordered Map Result ---- \n";
                clock_t timeTofindVal = clock();
                cout << "\nBlock: " << index << " | count: " << map.get_count(input);
                timeTofindVal = clock() - timeTofindVal;
                cout << "The hashmap took seconds " << (float)timeTofindVal / CLOCKS_PER_SEC << " to find the value." << endl;
                cout << "\n --- Graph Result ---- \n";
            ...
            else
            {
                ...
                timeTofindVal = clock() - timeTofindVal;
                cout << "\nThe hashmap took seconds " << (float)timeTofindVal / CLOCKS_PER_SEC << " to find the value." << endl;
                cout << "\n\n --- Graph Result ---- \n";
